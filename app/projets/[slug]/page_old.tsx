...
export default function ProjetPage() {
	...
	useGSAP(() => {
		...
		gsap.to(current, {
			scrollTrigger: {
				start: "top top",
				end: current.clientWidth + innerWidth * 2,
				scrub: true,
			},
				...
				<div ref={container} className="fixed flex">
					<div className="flex justify-center items-center min-w-[80vw] py-20 px-36">
						...
						<div className="relative">
							<h1 className="absolute -translate-y-1/4 -translate-x-1/4 -rotate-[5deg] transform: translateY(50%);transform: translateY(50%); uppercase font-secondary text-9xl italic font-extrabold shadow-title text-stroke text-customPurple "
